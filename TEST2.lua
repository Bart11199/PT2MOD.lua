--[[
    SCRIPT COMPLETO: SAPIEN V1 Script para Delta Executor
    Funciones:
      ...
      • PERFECTSHOT: al activarlo, se bloquea (lock-on) al enemigo más cercano cuando disparas o atacas.
      • Unlimited Stamina: si el juego tiene stamina, la pone en 100 constantemente.
...
------------------------------------------------
-- Ícono Toggle (para abrir/cerrar el menú)
------------------------------------------------
...
MenuFrame.Visible = true  -- Asegurar que el menú se abra al ejecutar
